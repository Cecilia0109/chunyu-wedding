...
const BridalContainer = () => {
  return (
    <Grid templateColumns="repeat(4, 1fr)" gap={4} width="70vw" templateRows="repeat(8, 10vh)" marginBottom={16} position="relative">
      <GridItem position="relative" gridRow="2/span 4" gridColumn={1} >
        <Image src={R1}  alt="bridals picture 1" layout="fill"/>
      </GridItem>
      <GridItem gridRow="1/span 3" gridColumn={4}  position="relative">
      <Image src={R2}  alt="bridals picture 2"  />
      </GridItem>
      <GridItem gridRow="5/span 4" gridColumn={3} position="relative">
      <Image src={R3}  alt="bridals picture 3" layout="fill"/>
      </GridItem>
      <GridItem gridRow="6/span 3" gridColumn={1} position="relative">
      <Image src={R4}  alt="bridals picture 3" layout="cover"/>
      </GridItem>
      <GridItem gridRow="1/span 4" gridColumn={2} position="relative">
      <Image src={R5}  alt="bridals picture 3" layout="fill"/>
      </GridItem>
      <GridItem gridRow="5/span 3" gridColumn={2} position="relative">
      <Image src={R9}  alt="bridals picture 3" layout="cover"/>
      </GridItem>
      <GridItem gridRow="2/span 3" gridColumn={3} position="relative">
      <Image src={R7}  alt="bridals picture 3" layout="fill"/>
      </GridItem>
      <GridItem gridRow="5/span 3" gridColumn={4} position="relative">
      <Image src={R8}  alt="bridals picture 3" layout="cover"/>
      </GridItem>
